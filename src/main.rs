...
fn print_help(program: &str) {
    ...
    println!();
    println!("Description:");
    println!("  Reads and writes options in brace-delimited config files such as");
    println!("  hyprland.conf.  Sections are matched by name and navigated with");
    println!("  colon-separated path components.  Missing sections and options are");
    println!("  created automatically on write; indent style is inferred from the");
    println!("  existing file (default: tab).");
    println!();
    println!("Path syntax:");
    ...
    println!("    All preceding components are section names.");
    println!();
    ...
    println!("  }}");
    println!("  # comment");
    println!("  top_level_option = value");
    println!();
    println!("  Lines beginning with '#' are treated as comments and are never");
    println!("  modified.  Indentation (spaces or tabs) is detected from the file");
    println!("  and matched when new lines are inserted.");
    println!("  Input values wrapped in single or double quotes have the quotes");
    println!("  stripped; an explicitly empty-quoted value (\"\") exits with code 1.");
    println!();
    println!("Exit codes:");
    println!("  0   success");
    ...
    println!();
    println!("  # Set a nested option (input > touchpad > natural_scroll)");
    println!("  {prog} input:touchpad:natural_scroll:yes hyprland.conf", prog = program);
    println!();
    println!("  # Set a top-level option");
    println!("  {prog} monitor:,preferred,auto,1 hyprland.conf", prog = program);
    println!();
    println!("  # Read from the last 'decoration' section");
    println!("  {prog} --get decoration@-1:rounding hyprland.conf", prog = program);
    println!();
    println!("  # Quote a value containing special characters");
